    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public static FeedbackActivity_.IntentBuilder_ intent(Fragment supportFragment) {
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        if (btnBaseRight!= null) {
            btnBaseRight.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    FeedbackActivity_.this.rightClick();
                }
        ...
        if (tvBaseRight!= null) {
            tvBaseRight.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    FeedbackActivity_.this.rightTextClick();
                }

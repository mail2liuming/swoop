...
public final class ChatRightItemView_
    extends ChatRightItemView
    implements HasViews, OnViewChangedListener
{
    ...
    public static ChatRightItemView build(Context context) {
        ChatRightItemView_ instance = new ChatRightItemView_(context);
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.item_comment_right, this);
